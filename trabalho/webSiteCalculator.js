...
var calculadora = document.getElementById("formulario")
var cont = document.getElementById("batata")
var btnCalculadora = document.getElementsByClassName("a4")
btnCalculadora[0].addEventListener("click", ()=>{
